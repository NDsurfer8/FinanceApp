...
export const createRecurringTransaction = async (
  ...
  try {
    ...
    console.log(
      "Recurring transaction created successfully with ID:",
      transactionId
    );
    ...
    if (targetMonth) {
      ...
      if (shouldCreateFirstTransaction) {
        ...
        console.log(
          "First actual transaction created for recurring transaction"
        );
      }
    }
...
export const getProjectedTransactionsForMonth = async (
  ...
  try {
    ...
    console.log(
      `Month analysis for ${targetMonthStart.toLocaleDateString()}:`,
      {
        isPastMonth,
        isCurrentMonth,
        isFutureMonth,
        currentMonth: monthType.currentMonthStart.toLocaleDateString(),
      }
    );
...
export const convertProjectedToActual = async (
  ...
  try {
    ...
    console.log("Converted projected transaction to actual transaction");
    return transactionId;
  } catch (error) {
